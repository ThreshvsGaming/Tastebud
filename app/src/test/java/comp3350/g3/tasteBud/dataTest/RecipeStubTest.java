...
public class RecipeStubTest {
    ...
    public void testGetStoredRecipes() {
        ArrayList<Recipe> storedRecipes = recipeStub.getStoredRecipes();
        ...
        assertArrayEquals(new String[]{"Chicken drumsticks", "Chicken", "Buttermilk", "Salt", "Pepper", "Flour", "Corn starch", "Paprika", "Onion powder"}, recipe1.getIngredients());
        assertArrayEquals(new String[]{"Dinner", "Fried"}, recipe1.getTags());
        ...
        assertArrayEquals(new String[]{"Chicken thighs", "Soy sauce", "Vinegar", "Garlic", "Bay leaves", "Peppercorns", "Brown sugar"}, recipe2.getIngredients());
        assertArrayEquals(new String[]{"Lunch", "Dinner", "Filipino"}, recipe2.getTags());
        ...
        assertArrayEquals(new String[]{"Basmati rice", "Marinated lamb", "Yogurt", "Onions", "Ginger", "Garlic", "Green chilies", "Saffron", "Ghee", "Whole spices"}, recipe3.getIngredients());
        assertArrayEquals(new String[]{"Dinner", "Indian"}, recipe3.getTags());
        ...
        assertArrayEquals(new String[]{"Calamari", "Flour", "Cornmeal", "Paprika", "Salt", "Pepper", "Garlic powder", "Egg", "Milk", "Oil"}, recipe4.getIngredients());
        assertArrayEquals(new String[]{"Appetizer", "Seafood", "Fried"}, recipe4.getTags());
    }
